...
class PineconeComponent extends PositionComponent {
  PineconeComponent({required super.size});
  ...
  Future onLoad() async {
    ...
    _spine = await SpineComponent.fromAssets(
      atlasFile: 'assets/sprites/pinecone/pinecone.atlas',
      skeletonFile: 'assets/sprites/pinecone/pinecone.json',
