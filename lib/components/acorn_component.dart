...
class AcornComponent extends PositionComponent {
  AcornComponent({required super.size});
  ...
  Future onLoad() async {
    ...
    _spine = await SpineComponent.fromAssets(
      atlasFile: 'assets/sprites/acorn/acorn.atlas',
      skeletonFile: 'assets/sprites/acorn/acorn.json',
