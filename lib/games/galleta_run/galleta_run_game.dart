...
// import 'components/dust_particle.dart';
...
// class GalletaRunGame extends LaraBaseGame with HasCollisionDetection, TapCallbacks {
...
//     // Dust emitter: trail behind Galleta's feet while she runs on ground.
//     final dust = _dustEmitter;
//     if (dust != null) {
//       dust.enabled = !g.airborne;
//       dust.emitPosition = Vector2(g.position.x - 38, g.position.y + g.size.y / 2 - 6);
//     }
...
//     _running = false;
//     _dustEmitter?.enabled = false;
//     lastEntry = GalletaRunLeaderboard.submit(_score);
//     await _galleta?.crash();
