...
// class TutorialHint extends PositionComponent with HasGameReference<TapHeartGame> {
...
//         ],
//       ),
//     ).render(canvas, '¡Toca los corazones!', Vector2(size.x / 2, 10),
...
//       ),
//     ).render(canvas, 'Cógelos antes de que caigan', Vector2(size.x / 2, 40),
//         anchor: Anchor.topCenter);
//   }
// }
