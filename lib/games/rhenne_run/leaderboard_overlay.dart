...
/// Game-over overlay for Rhenné Corre. Renders the in-memory leaderboard
...
class LeaderboardOverlay extends StatelessWidget {
  ...
  final LeaderboardEntry? justPlayed;
  final VoidCallback onRestart;
  final VoidCallback onHome;

  @override
  Widget build(BuildContext context) {
    final entries = RhenneRunLeaderboard.topEntries.take(5).toList();
    final myRank = justPlayed == null
        ? null
        : RhenneRunLeaderboard.rankOf(justPlayed!);
