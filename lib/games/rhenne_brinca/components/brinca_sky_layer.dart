...
/// Sky atmosphere: soft sun disc + 7 swaying golden rays filling the upper portion.
class BrincaSkyLayer extends PositionComponent
  ...
  void onMount() {
    ...
    priority = -900;
    size     = game.size;
    _rays    = List.generate(_rayCount, (i) => _Ray(
  ...
  void render(Canvas canvas) {
    ...
    canvas.drawCircle(
      Offset(sunCx, 0),
      sunR,
      Paint()..color = LaraColors.yellow.withValues(alpha: 0.55),
    );
    // Halo ring
    canvas.drawCircle(
      Offset(sunCx, 0),
