...
class BrincaWaterLayer extends PositionComponent
  ...
  void onMount() {
    ...
    _shimmers = List.generate(_shimmerCount, (i) => _Shimmer(
      xFrac: 0.05 + i * 0.18 + rng.nextDouble() * 0.08,
  ...
  void render(Canvas canvas) {
    ...
    canvas.drawRect(
      ...
      Paint()
        ..color = LaraColors.mint.withValues(alpha: 0.62),
    );
